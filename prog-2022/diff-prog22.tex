...
%DIF DEL old-prog22.tex   Wed Sep 28 15:12:55 2022
%DIF ADD new-prog22.tex   Fri Sep 30 15:31:07 2022
...
\begin{abstract}
  ...
  \emph{Importance.} Much research effort focuses on building programming systems that are easier to use, accessible to non-experts, moldable and/or powerful, but such efforts are disconnected. They are informal, guided by the personal vision of \DIFdelbegin \DIFdel{the }\DIFdelend \DIFaddbegin \DIFadd{their }\DIFaddend authors and thus are only evaluable and comparable on the basis of individual experience using them. By providing foundations for more systematic research, we can help programming systems researchers to stand, at last, on the shoulders of giants.
...
\DIFaddend This paper advocates a shift of attention from \emph{programming
languages} to the more general notion of ``software that enables
programming''---in other words, \emph{programming systems}.
...
\DIFdelbegin %DIFDELCMD < \hypertarget{what-is-the-problem}{%
%DIFDELCMD < \subsection{What is the problem?}\label{what-is-the-problem}}
%DIFDELCMD < %%%
...
spreadsheets, or motivational illustrations \DIFdelbegin \DIFdel{by thinkers like }\DIFdelend \DIFaddbegin \DIFadd{like those of Bret
}\DIFaddend Victor~\cite{BretVictor}.
...
demonstrate \DIFdelbegin \DIFdel{the }\DIFdelend \DIFaddbegin \DIFadd{their }\DIFaddend author's ideas, but are inadequate methods for
comparing new ideas with the work of others. This makes it hard to build
on top and thereby advance the state of the art.
...
design trade-offs. At this \DIFdelbegin \DIFdel{stage }\DIFdelend \DIFaddbegin \DIFadd{early stage in the life of such a framework,
}\DIFaddend we encourage agreement on descriptions of systems first \DIFdelbegin \DIFdel{, }\DIFdelend in order to
...
present systems will serve as landmarks, and with enough of them, \DIFaddbegin \DIFadd{we may
reveal }\DIFaddend unexplored or overlooked possibilities\DIFdelbegin \DIFdel{will reveal themselves}\DIFdelend . So far, the field has not
been able to establish a virtuous cycle of feedback; it is hard for
practitioners to situate their work in the context of others' so that
subsequent work can improve on it. Our aim is to provide foundations for
the study of programming systems that would allow such development.
...
\tightlist
\item
  Computational notebooks such as Jupyter\DIFdelbegin \DIFdel{simplify }\DIFdelend \DIFaddbegin \DIFadd{~\mbox{%DIFAUXCMD
\cite{Jupyter} }\hspace{0pt}%DIFAUXCMD
facilitate }\DIFaddend data
...
work in an effective manner. In Kuhnian terms\DIFaddbegin \DIFadd{~\mbox{%DIFAUXCMD
\cite{Kuhn}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend , it should
...
\DIFdelbegin \DIFdel{We see programming systems as (collections of) software artifacts that
...
appropriate hardware. }\DIFdelend Text-based programming languages sit within programming systems whose
boundaries are not explicitly defined. To speak of a programming system,
we need to consider a language with, at minimum, an editor and a
compiler or interpreter. However, the exact boundaries are a design
choice that significantly affects our analysis.
...
highlighting and auto-completion. \DIFdelbegin \DIFdel{In general, we can consider any }\DIFdelend \DIFaddbegin \DIFadd{Any }\DIFaddend editor that supports the Language
Server Protocol\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{LSP}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{~\mbox{%DIFAUXCMD
\cite{LSP} }\hspace{0pt}%DIFAUXCMD
will suffice to complete the programming
system}\DIFaddend .
...
\DIFdelbegin \DIFdel{The first O-type programming systems emerged in }\DIFdelend \DIFaddbegin \DIFadd{``OS-likes'' begin from }\DIFaddend the 1960s when it became possible to interact
