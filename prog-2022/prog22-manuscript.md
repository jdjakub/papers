...
2. We present the technical dimensions in detail, organised into related clusters: *interaction*, *notation*, *conceptual structure*, *customizability*, *complexity*, *errors*, and *adoptability*. For each dimension, we give examples that illustrate the range of values along its axis. Of these, only *customizability* fits in the main body of the paper; the rest reside in Appendix\ \ref{dimensions-catalogue}.
...
For space reasons, we are only able to include one cluster, *customizability*, in the main body of this paper. We encourage the reader to peruse Appendix\ \ref{dimensions-catalogue} for the full extent of our proposed dimensions.
