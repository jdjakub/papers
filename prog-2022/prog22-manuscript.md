...
- Computational notebooks such as Jupyter\ \cite{Jupyter} simplify data analysis by combining code snippets with text and visual output. They are backed by stateful "kernels" and used interactively.
