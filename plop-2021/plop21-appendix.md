...
*Uniformity (Uniformity of interaction) and Interaction Structure* (Section \ref{interaction-structure}): the two of these determine whether there are separate stages for running and writing programs and may thus influence what kind of customizability is possible.
