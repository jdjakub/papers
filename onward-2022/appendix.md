...
Recall Heuristic\ \ref{simple-asm} which instructed us to pursue an easy-to-implement instruction set. We pursued this goal to the extreme out of curiosity at what was possible. Of course, it turned out that the corresponding explosion in the number of instructions necessary to do a simple thing outweighed any implementation advantage...
